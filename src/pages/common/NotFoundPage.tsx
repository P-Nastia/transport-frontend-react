...
const NotFoundPage: React.FC = () => {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-white text-gray-900 dark:text-white p-6">
            <h1 className="text-6xl md:text-8xl font-bold text-purple-500 dark:text-purple-400 mb-4">404</h1>
            ...
            <Link
                to="/"
                className="mt-8 bg-purple-500 dark:bg-purple-600 hover:bg-purple-700 dark:hover:bg-purple-700 transition text-white px-6 py-3 rounded-full text-lg font-medium"
            >
                Повернутися додому
            </Link>
        </div>
