...
console.log("COUNTRIES",countries);
    return (
        <div className="w-full flex flex-col">
            ...
            <section className="bg-gradient-to-r from-purple-800 to-purple-500 text-white py-28 px-4 text-center shadow-xl">
                ...
                <button className="
                    bg-white text-purple-700 font-semibold px-10 py-4
            ...
            <section className="max-w-7xl w-full mx-auto py-16 px-4">
                <h2 className="text-4xl font-bold text-center mb-12 text-purple-700 drop-shadow-sm">
                    Популярні напрямки
                </h2>
